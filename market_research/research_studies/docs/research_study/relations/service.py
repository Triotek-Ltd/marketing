"""Relation service seed for research_study."""
...
RELATED_DOCS = [{'doc_id': 'segment_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'survey_response', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'market_insight', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'segment identity from segment_profile'}]
