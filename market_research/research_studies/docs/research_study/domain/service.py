"""Business-domain service seed for Research Study."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'case_flow', 'supports_assignment': True, 'supports_escalation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': False}, 'integration_profile': {'external_sync_enabled': False}, 'lifecycle_states': ['draft', 'approved', 'active', 'completed', 'archived'], 'is_transactional': False}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'start_date': 'schedule_marker', 'end_date': 'schedule_marker', 'study_status': 'status_flag', 'related_segment_profile': 'relation_collection', 'related_survey_response': 'relation_collection', 'related_market_insight': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'study_code', 'objective', 'owner'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'active', 'completed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'launch': None, 'close': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports product, pricing, sales, and campaign decisions'], 'related_docs': ['segment_profile', 'survey_response', 'market_insight'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'launch': None, 'close': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
