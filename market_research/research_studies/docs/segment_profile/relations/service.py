"""Relation service seed for segment_profile."""
...
RELATED_DOCS = [{'doc_id': 'research_study', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'value_proposition', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
