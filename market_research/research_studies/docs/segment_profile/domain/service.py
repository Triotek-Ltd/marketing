"""Business-domain service seed for Segment Profile."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'related_research_study': 'relation_collection', 'related_value_proposition': 'relation_collection', 'related_campaign_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'segment_code', 'name', 'criteria'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['supports product, pricing, sales, and campaign decisions'], 'related_docs': ['research_study', 'value_proposition', 'campaign_record'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
