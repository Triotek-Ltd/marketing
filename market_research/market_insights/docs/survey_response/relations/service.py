"""Relation service seed for survey_response."""
...
RELATED_DOCS = [{'doc_id': 'research_study', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'segment_profile', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'market_insight', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'study'}, {'description': 'segment context from linked records'}]
