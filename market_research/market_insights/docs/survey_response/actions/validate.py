"""Action handler seed for survey_response:validate."""
...
ACTION_ID = "validate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['received', 'validated'], 'transitions_to': None}
...
def handle_validate(payload: dict, context: dict | None = None) -> dict:
    context = context or {}
