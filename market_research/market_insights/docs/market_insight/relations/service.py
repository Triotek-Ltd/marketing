"""Relation service seed for market_insight."""
...
RELATED_DOCS = [{'doc_id': 'research_study', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'survey_response', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'product_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'source context from research_study or survey_response'}]
