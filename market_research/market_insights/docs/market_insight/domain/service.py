"""Business-domain service seed for Market Insight."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'owner': 'actor_reference', 'related_research_study': 'relation_collection', 'related_survey_response': 'relation_collection', 'related_product_record': 'relation_collection', 'related_campaign_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'insight_code', 'source_study_or_signal', 'insight_title'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'reviewed', 'published', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': 'reviewed', 'publish': 'published', 'archive': 'archived'}}
...
SIDE_EFFECT_HINTS = {'downstream_effects': ['feeds opportunity, negotiation, and forecast workflows'], 'related_docs': ['research_study', 'survey_response', 'product_record', 'campaign_record'], 'action_targets': {'create': None, 'review': 'reviewed', 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
