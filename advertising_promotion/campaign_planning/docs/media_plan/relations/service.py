"""Relation service seed for media_plan."""
...
DOC_ID = "media_plan"
RELATED_DOCS = [{'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'campaign_result', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'campaign dates'}, {'description': 'budget from campaign_record'}]
