...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'start_date': 'schedule_marker', 'end_date': 'schedule_marker', 'owner': 'actor_reference', 'campaign_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'campaign_code', 'objective', 'budget'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'active', 'paused', 'completed', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'launch': None, 'pause': None, 'close': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {'business_objective': 'plan, approve, launch, and monitor promotional campaigns against budget and objectives', 'actors': ['campaign owner', 'approver', 'analyst'], 'start_condition': 'a campaign objective and budget are approved', 'ordered_steps': ['Create the campaign record and objective.'], 'primary_actions': ['create', 'review'], 'primary_transitions': ['campaign_record: draft -> planned'], 'downstream_effects': ['supports digital execution, brand review, and revenue analysis']}
