"""Relation service seed for campaign_record."""
...
RELATED_DOCS = [{'doc_id': 'promotion_offer', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'media_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'campaign_result', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'brand_campaign_brief', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'audience'}, {'description': 'messaging from brand_campaign_brief'}]
