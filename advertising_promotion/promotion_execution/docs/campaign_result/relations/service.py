"""Relation service seed for campaign_result."""
...
RELATED_DOCS = [{'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'media_plan', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'lead_capture_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'planned budget'}, {'description': 'dates from linked campaign or media plan'}]
