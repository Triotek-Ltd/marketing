"""Relation service seed for promotion_offer."""
...
RELATED_DOCS = [{'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pricing_decision', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'sales_order', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'campaign objective from campaign_record'}, {'description': 'base pricing from pricing_decision'}]
