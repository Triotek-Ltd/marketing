"""Relation service seed for brand_guideline."""
...
RELATED_DOCS = [{'doc_id': 'brand_asset', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'brand_campaign_brief', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
