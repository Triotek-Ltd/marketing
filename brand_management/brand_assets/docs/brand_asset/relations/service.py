"""Relation service seed for brand_asset."""
...
DOC_ID = "brand_asset"
RELATED_DOCS = [{'doc_id': 'brand_guideline', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'brand_campaign_brief', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
