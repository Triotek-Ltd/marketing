"""Relation service seed for brand_campaign_brief."""
...
RELATED_DOCS = [{'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'brand_asset', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'brand_guideline', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'brand rules from brand_guideline'}]
