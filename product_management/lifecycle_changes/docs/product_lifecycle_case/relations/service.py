"""Relation service seed for product_lifecycle_case."""
...
RELATED_DOCS = [{'doc_id': 'product_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pricing_decision', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_change', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'product identity'}, {'description': 'lifecycle stage from product_record'}]
