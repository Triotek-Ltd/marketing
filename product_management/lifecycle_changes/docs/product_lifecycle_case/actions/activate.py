"""Action handler seed for product_lifecycle_case:activate."""
...
ACTION_ID = "activate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['proposed', 'in_review', 'approved', 'in_progress', 'completed', 'cancelled'], 'transitions_to': None}
