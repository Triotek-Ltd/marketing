"""Action handler seed for product_lifecycle_case:review."""
...
ACTION_ID = "review"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['proposed', 'in_review', 'approved', 'in_progress', 'completed', 'cancelled'], 'transitions_to': 'in_review'}
