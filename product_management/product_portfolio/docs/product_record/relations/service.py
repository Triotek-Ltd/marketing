"""Relation service seed for product_record."""
...
RELATED_DOCS = [{'doc_id': 'product_lifecycle_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'pricing_decision', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'catalog_change', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
