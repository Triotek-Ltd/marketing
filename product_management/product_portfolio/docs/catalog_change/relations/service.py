"""Relation service seed for catalog_change."""
...
RELATED_DOCS = [{'doc_id': 'product_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'product_lifecycle_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'product identity from product_record'}]
