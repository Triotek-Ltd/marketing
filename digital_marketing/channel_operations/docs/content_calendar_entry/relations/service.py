"""Relation service seed for content_calendar_entry."""
...
RELATED_DOCS = [{'doc_id': 'digital_channel', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'channel identity from digital_channel'}]
