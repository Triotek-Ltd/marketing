"""Business-domain service seed for Content Calendar Entry."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'transaction_flow', 'supports_submission': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['draft', 'approved', 'scheduled', 'published', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'transaction_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'transaction_date': 'transaction_date', 'party': 'primary_party', 'currency': 'currency_code', 'total_amount': 'total_amount', 'publish_date': 'schedule_marker', 'owner': 'actor_reference', 'approval_status': 'status_flag', 'related_campaign_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'entry_code', 'channel', 'content_theme'], 'list_columns': ['title', 'reference_no', 'transaction_date', 'party', 'total_amount', 'workflow_state'], 'initial_state': 'draft', 'lifecycle_states': ['draft', 'approved', 'scheduled', 'published', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'schedule': None, 'publish': 'published', 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['digital_channel', 'campaign_record'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'schedule': None, 'publish': 'published', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
