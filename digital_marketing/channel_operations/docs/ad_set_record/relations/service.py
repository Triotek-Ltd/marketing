"""Relation service seed for ad_set_record."""
...
RELATED_DOCS = [{'doc_id': 'campaign_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'digital_channel', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'lead_capture_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'campaign objective from campaign_record'}, {'description': 'channel details from digital_channel'}]
