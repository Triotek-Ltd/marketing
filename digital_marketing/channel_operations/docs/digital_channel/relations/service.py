"""Relation service seed for digital_channel."""
...
RELATED_DOCS = [{'doc_id': 'content_calendar_entry', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'ad_set_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'lead_capture_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
