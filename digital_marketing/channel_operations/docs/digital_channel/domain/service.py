"""Business-domain service seed for Digital Channel."""
...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'owner': 'actor_reference', 'active_status': 'status_flag', 'related_content_calendar_entry': 'relation_collection', 'related_ad_set_record': 'relation_collection', 'related_lead_capture_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'channel_code', 'channel_name', 'channel_type'], 'list_columns': ['title', 'reference_no', 'workflow_state', 'modified'], 'initial_state': 'active', 'lifecycle_states': ['active', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['content_calendar_entry', 'ad_set_record', 'lead_capture_record'], 'action_targets': {'create': None, 'update': None, 'review': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}

class DomainService:
    doc_id = "digital_channel"
    archetype = "master"
    doc_kind = "master"
