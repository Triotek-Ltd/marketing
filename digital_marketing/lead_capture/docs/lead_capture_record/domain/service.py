"""Business-domain service seed for Lead Capture Record."""

from __future__ import annotations


ARCHETYPE_PROFILE = {'workflow_profile': {'mode': 'posting_flow', 'supports_reconciliation': True}, 'reporting_profile': {'supports_snapshots': True, 'supports_outputs': True}, 'integration_profile': {'external_sync_enabled': True, 'tracks_external_refs': True}, 'lifecycle_states': ['captured', 'qualified', 'discarded', 'archived'], 'is_transactional': True}

CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'captured_at': 'schedule_marker', 'related_digital_channel': 'relation_collection', 'related_campaign_record': 'relation_collection', 'related_lead_record': 'relation_collection'}, 'search_fields': ['title', 'reference_no', 'description', 'capture_code', 'source_channel', 'source_campaign'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'captured', 'lifecycle_states': ['captured', 'qualified', 'discarded', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'qualify': None, 'discard': None, 'archive': 'archived'}}

WORKFLOW_HINTS = {}

SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['digital_channel', 'campaign_record', 'lead_record'], 'action_targets': {'record': None, 'qualify': None, 'discard': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
